...
# !! TODO: Create Images tutorial 

1. Manuallly add tree more screens
2. Add menu items: first screen: files list and  second is jpeg files viewer, third will be properties and fourth will be our existed  menu, menu items will be delete and 
